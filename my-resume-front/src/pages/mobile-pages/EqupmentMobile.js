    ...
    return (
        <div className="project-page" >
            ...
            <div className="project-page-inner-mobile" >
                ...
                <div className="nav-buttons-mobile" id='nav-buttons-equpment'>
                ...
                <div className="project-main-mobile">
                    <p className="project-expl-mobile" id="project-expl-equpment">
                        <p>
                    ...
                    <div className="project-screenshots-equpment" id='project-screenshots-mobile'>
